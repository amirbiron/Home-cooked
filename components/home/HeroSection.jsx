      ...
      <div className="relative max-w-7xl mx-auto px-4 py-16 md:py-24">
        <div className="text-center max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-orange-100 text-orange-700 px-4 py-2 rounded-full text-sm font-medium mb-6">
            ...
            <span>אוכל ביתי אמיתי, ישירות מהמטבח</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            מאות מבשלים ביתיים מוכשרים מחכים לכם עם מנות מיוחדות, 
            מתכונים משפחתיים ואוכל שמכינים באהבה
          </p>
          ...
          <form onSubmit={handleSearch} className="max-w-xl mx-auto mb-12">
            <div className="relative">
              ...
              <Input
                type="text"
                placeholder="חפשו לפי עיר, סגנון או שם מבשל..."
                value={searchQuery}
          ...
          <div className="flex flex-wrap justify-center gap-8 md:gap-16">
            <div className="text-center">
              ...
              <div className="text-gray-600">מבשלים פעילים</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-orange-600">2,500+</div>
              <div className="text-gray-600">מנות לבחירה</div>
            </div>
            <div className="text-center">
